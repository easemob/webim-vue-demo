<template>
  <Draggable id="drag2">
    <div ref="rtc" class="webim-rtc-video">
      ...
      <div class="video full" :style="{'display':'block'}" ref='localVideo' id="local-player"></div>
      <div class="video corner" :style="{'display': 'block'}" ref='remoteVideo' id="remote-player"></div>
    </div>
  </Draggable>
</template>
