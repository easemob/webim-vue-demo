  ...
  <div>
    ...
    >
      ...
      <div class="stream_container" ref="streamContainer">
        ...
        <!-- 通话容器页面 -->
        <template
          v-if="callKitStatus.localClientStatus === CALLSTATUS.confirmCallee"
        >
          <div class="time">
          ...
          >
            <div
              ...
              ref="smallContainer"
              @click="
                () => defaultStreamContainerClass && changeStreamContainer()
              "
            ></div>
            <div
              :class="[
        ...
        <div v-show="!isOutside" class="stream_control">
          ...
          >
            ...
            >
              <img
                :src="localStreamStatus.voice ? microphone : mutemicrophone"
                alt=""
                draggable="false"
              />
